...
export default class CourseItemDetails extends Component {
  state = {isLoading: true, isFailed: false, isSuccess: false, ItemDeatils: {}}
  ...
  render() {
    const {isLoading, isFailed, isSuccess, ItemDeatils} = this.state
    const {description, name, imageUrl} = ItemDeatils
    return (
      <div>
        <Header />
        <div>
